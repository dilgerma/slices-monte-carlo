              ...
              <div className="box">
                <div className="notification is-info">
                  <p><strong>Loaded Slices:</strong> {slices.length}</p>
                      ...
                      <p className="help">Working Days: {calculateWorkingDays(startDate, deadlineDate)}</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="field">
                  ...
                  />
                  <p className="help">
                    Reduces throughput by up to this percentage (0 = no reduction, 0.2 = up to 20% slower).
